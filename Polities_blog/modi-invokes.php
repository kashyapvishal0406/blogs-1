...
<head>
    ...
    <title>MICRO JOBS WORK || Modi Invokes</title>
    <meta name="description" content="Modi invokes Guru Ravidas, says welfare his top priority">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="layout-img mb-50">
                            <img src="img/pm-modi-2.webp" alt="">
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="layout-wrapper layout-wrapper-02 mb-30">
                            <div class="lifestyle-wrapper mb-55">
                                <div class="lifestyle-text lifestyle-02-text">
                                    ...
                                    <h4><a href="#">Modi invokes Guru Ravidas, says welfare his top priority
                                        </a></h4>
                                    <p style="text-align: justify;">Prime Minister Narendra Modi emphasised the need for a full majority government at the Centre. He said that Guru Ravidas was his inspiration for prioritising the welfare of the poor during a rally in Punjab's Hoshiarpur. He highlighted the country's development
                            ...
                            <div class="row mt-60 mb-20">
                                <div class="col-xl-7">
                                    <div class="layout-text mb-30">
                                        <h3>Which of the five Sikh warriors was Modi referring to?


                                        </h3>
                                        <p>Modi was referring to Mohkam Chand, who was born to Tirath Chand and Devi Bai in Dwarka, and named Bhai Mohkam Singh by Guru Gobind Singh.
                                        ...
                                        <ul class="layout-link">
                                            <li>How did Mohkam Singh become one of the Panj Pyaaras</li>
                                            <li>Who were the other four Panj Pyaaras</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-xl-5">
                                    <div class="layout-img mb-30">
                                        <img src="img/modi-2.avif" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="layout-content mt-25 mb-50">
                                <h3>How did Mohkam Singh become one of the Panj Pyaaras</h3>
                                <p>Bhai Mohkam Singh arrived in Anandpur Sahib in 1685. He soon trained in martial arts, becoming an expert and, in turn, training Guru Gobind Singh’s army.

                                </p>
                                <p>In 1699, Guru Gobind Singh, at a historic congregation in Anandpur Sahib, asked for the heads of five persons who wanted to respect the five ‘Kakars’ (or items – kesh, kangha, kara, kachera, and kirpan) which the Guru had commanded Khalsa Sikhs to wear at all times. “While most upper castes, who believed in mundan (shaving heads of male children), refused to keep long hair (one of the five requirements), five men offered their heads to the Guru,” Dr Dhillon said.

                                </p>
                                <p>Guru Gobind Singh then took the first man inside a tent, where he had kept a goat. He then came out with a knife smeared with its blood. “Despite this, the other four men offered their heads. Later, they were baptised and Guru Gobind Singh named them the Panj Pyaras,” he said. Bhai Mohkam Singh was the fourth to offer his head.</p>
                            </div>
