...
<head>
    ...
    <title>Sport Blog List</title>
    <meta name="description" content="Athlete Mental Health: Breaking the Stigma and Prioritizing Well-being">
...
<body>
    ...
    <main>
        ...
        <div class="breadcrumb-area pt-30 hero-padding">
            <div class="container">
                <div class="breadcrumb-bg pt-115 pb-115" style="background-image:url(Sport_blog/img/sport-banner.webp)">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="row mb-30">
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
                                <div class="postbox">
                                    <div class="post-img">
                                        <a href="Sport_blog/kkr.php"><img src="Sport_blog/img/kkr.webp" alt=""></a>
                                    </div>
                                    <div class="post-box-text mt-30">
                                        <div class="post-box-meta">
                                            <span class="post-box-cart color-1"><a href="Sport_blog/kkr.php">Sport</a></span>
                                            <span class="post-box-cart1"><a href="Sport_blog/kkr.php"><i class="far fa-calendar-alt"></i> 30 May 2024</a></span>
                                        </div>
                                        <h4><a href="Sport_blog/kkr.php">KKR Won 2024 IPL</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
                                <div class="postbox">
                                    <div class="post-img">
                                        <a href="Sport_blog/athlete-mental-health.php"><img src="Sport_blog/img/Athlete.jpg" alt=""></a>
                                    </div>
                                    <div class="post-box-text mt-30">
                                        <div class="post-box-meta">
                                            <span class="post-box-cart color-2"><a href="Sport_blog/athlete-mental-health.php">Sport</a></span>
                                            <span class="post-box-cart1"><a href="Sport_blog/athlete-mental-health.php"><i class="far fa-calendar-alt"></i> 30 May 2024</a></span>
                                        </div>
                                        <h4><a href="Sport_blog/athlete-mental-health.php">Athlete Mental Health: Breaking the Stigma and Prioritizing Well-being</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
