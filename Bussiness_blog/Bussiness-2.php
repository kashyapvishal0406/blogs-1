...
<head>
    ...
    <title>MICRO JOBS WORK || Bussiness Blog </title>
    <meta name="description" content="RBI Annual Report 2023-24: Inflation to ease further, MPC focused on price stability">
                        ...
                        <div class="layout-wrapper layout-wrapper-02 mb-30">
                            <div class="lifestyle-wrapper mb-55">
                                <div class="lifestyle-text lifestyle-02-text">
                                    ...
                                    <h4><a href="#">
                                            RBI Annual Report 2023-24: Inflation to ease further, MPC focused on price stability
                                        </a></h4>
                                    <p style="text-align: justify;">Banking regulator RBI has on May 30 released its annual report for 2023-24, highlighting that macro-economic fundamentals remain strong, with headline inflation expected to moderate further.
                            ...
                            <div class="row mt-60 mb-20">
                                <div class="col-xl-7">
                                    <div class="layout-text mb-30">
                                        <h3>View |Now, Edelweiss faces RBI’s wrath: What explains the recent spate of tough actions by central bank


                                        </h3>
                                        <p>The Reserve Bank of India (RBI) has yet again cracked the whip on one of the leading names in the Indian financial services industry, the Rashesh Shah-led Edelweiss group.
                                        </p>
                                        <ul class="layout-link">
                                            <li>On May 29 evening, the central bank clamped down on ECL Finance Ltd, the non-banking finance (NBFC) arm of Edelweiss, and EARCL, the asset reconstruction company led by veteran banker Rajkumar Bansal, who was with IDBI Bank for a long time.</li>
                                            <li>While ECL Finance has been asked to stop structured transactions, EARCL has been barred from acquiring financial ../assets, including security receipts (SRs). These are major business restrictions.</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-xl-5">
                                    <div class="layout-img mb-30">
                                        <img src="img/rbi-2.avif" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="layout-content mt-25 mb-50">
                                <h3>RBI imposes business restrictions on ECL Finance, Edelweiss ARC citing material concerns</h3>
                                <p>RBI has directed ECL Finance (ECL) to cease and desist, with immediate effect, from undertaking any structured transactions in respect of its wholesale exposures, other than repayment and/ or closure of accounts in its normal course of business.
                                </p>
                                <p>The Reserve Bank of India (RBI) on May 29 announced supervisory actions against ECL Finance Limited and Edelweiss Asset Reconstruction Company Limited citing material supervisory concerns.
                                </p>
                                <p>The Reserve Bank has directed ECL Finance Ltd (ECL) to cease and desist, with immediate effect, from undertaking any structured transactions in respect of its wholesale exposures, other than repayment and/ or closure of accounts in its normal course of business.
