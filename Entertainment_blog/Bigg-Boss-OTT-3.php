...
<head>
    ...
    <title>MICRO JOBS WORK || Bigg-Boss-OTT-3</title>
    <meta name="description" content="Bigg Boss OTT 3: Anil Kapoor's ‘Ab Sab Badlega’ new promo out now | WATCH">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="layout-img mb-50">
                            <img src="img/BIGG-BOSS-OTT-3.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="layout-text mb-30">
                                        ...
                                        <ul class="layout-link">
                                            ...
                                            <li>Jatin Talwar</li>
                                            <li>Nidhi Talwar</li>
                                            <li>Khushi Punjaban</li>
                                            <li>Vivek Chaudhary</li>
                                            <li>Cheshta Bhagat</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-xl-5">
                                    <div class="layout-img mb-30">
                                        <img src="img/anil-kapoor-2.webp" alt="">
