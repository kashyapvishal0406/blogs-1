...
<head>
    ...
    <title>MICRO JOBS WORK || Celebrity Gossip</title>
    ...
    <meta name="description" content="Celebrity Gossip Roundup: June 2024">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="layout-img mb-50">
                            <img src="img/Kourtney-Kardashian.jfif" alt="">
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="layout-wrapper layout-wrapper-02 mb-30">
                            <div class="lifestyle-wrapper mb-55">
                                <div class="lifestyle-text lifestyle-02-text">
                                    ...
                                    <h4><a href="#">
                                            Celebrity Gossip Roundup: June 2024
                                        </a></h4>
                                    <p style="text-align: justify;">June 2024 has been buzzing with exciting celebrity news, from new arrivals to surprising career moves. Here's a look at the latest gossip making waves in Hollywood and beyond.
                                    </p>
                                </div>
                            </div>
                            <blockquote>
                            ...
                            <div class="row mt-60 mb-20">
                                <div class="col-xl-7">
                                    <div class="layout-text mb-30">
                                        <h3>Kourtney Kardashian and Travis Barker Welcome Baby Rocky</h3>
                                        <p>Kourtney Kardashian and Travis Barker have shared their joy with the world, welcoming their newborn son, Rocky. Kourtney posted an adorable photo of Rocky's tiny foot on Instagram, sending fans into a frenzy. The couple is enjoying this new chapter in their lives, and the internet can't get enough of the heartwarming updates​ (Peoplemag)​.
                                        </p>
                                        <h3>Jennifer Lopez Puts Family First, Cancels Tour
                                        </h3>
                                        <p>In a heartfelt decision, Jennifer Lopez has canceled her upcoming tour to spend more time with her family. The superstar expressed that, despite her love for performing, her family needs her more right now. Fans are supportive, sending love and understanding through social media, showing that even global icons need personal time​ (Entertainment Tonight)​.</p>
                                    </div>
                                </div>
                                <div class="col-xl-5">
                                    <div class="layout-img mb-30">
                                        <img src="img/ko.jfif" alt="">
                                        <img src="img/Jennifer.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="layout-content mt-25 mb-50">
                                <h3>Taylor Momsen's Rock and Roll Moment with AC/DC</h3>
                                <p>Taylor Momsen had an unforgettable moment on stage while opening for AC/DC with her band, The Pretty Reckless. The singer was bitten by a bat during her performance but handled it like a true rockstar, continuing the show without missing a beat. This incident has only bolstered her rock and roll credentials​ (Entertainment Tonight)​.
                                    <img class=" mb-30" src="img/taylor.webp" alt="">
                                </p>
                                <h3>Paris Hilton Announces Second Album</h3>
                                <p>
                                    Paris Hilton is making a musical comeback with her second album, "Infinite Icon." This announcement has thrilled fans who remember her debut album, "Stars Are Blind," from nearly two decades ago. Paris promises a mix of dance tracks and introspective songs, reflecting her growth as an artist and a person​ (Peoplemag)​​ (Entertainment Tonight)​.
                                </p>
