...
<body>
    ...
    <main>
        ...
        <div class="breadcrumb-area pt-30 hero-padding">
            <div class="container">
                <div class="breadcrumb-bg pt-115 pb-115" style="background-image:url(Health_blog/img/health-banner-4.jpg)">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="row mb-30">
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
                                <div class="postbox">
                                    <div class="post-img">
                                        <a href="Corporate_blog/Corporate-1.php"><img src="Health_blog/img/health-1.png" alt=""></a>
                                    </div>
                                    <div class="post-box-text mt-30">
                                        <div class="post-box-meta">
                                            <span class="post-box-cart color-1"><a href="Health_blog/health-1.php">Corporate</a></span>
                                            <span class="post-box-cart1"><a href="Health_blog/health-1.php"><i class="far fa-calendar-alt"></i> 30 May 2024</a></span>
                                        </div>
                                        <h4><a href="Health_blog/health-1.php">A hot weather plan is essential to staying healthy</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
