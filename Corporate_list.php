...
<head>
    ...
    <meta name="description" content="How to get a corporate credit card for your business">
...
<body>
    ...
    <main>
        ...
        <div class="breadcrumb-area pt-30 hero-padding">
            <div class="container">
                <div class="breadcrumb-bg pt-115 pb-115" style="background-image:url(Corporate_blog/img/corporate-banner.png)">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="row mb-30">
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
                                <div class="postbox">
                                    <div class="post-img">
                                        <a href="Corporate_blog/Corporate-1.php"><img src="Corporate_blog/img/Corporate-1.jpeg" alt=""></a>
                                    </div>
                                    <div class="post-box-text mt-30">
                                        <div class="post-box-meta">
                                            <span class="post-box-cart color-1"><a href="Corporate_blog/Corporate-1.php">Corporate</a></span>
                                            <span class="post-box-cart1"><a href="Corporate_blog/Corporate-1.php"><i class="far fa-calendar-alt"></i> 30 May 2024</a></span>
                                        </div>
                                        <h4><a href="Corporate_blog/Corporate-1.php">How to get a corporate credit card for your business</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
                                <div class="postbox">
                                    <div class="post-img">
                                        <a href="Corporate_blog/Corporate-2.php"><img src="Corporate_blog/img/Corporate-2.jpg" alt=""></a>
                                    </div>
                                    <div class="post-box-text mt-30">
                                        <div class="post-box-meta">
                                            <span class="post-box-cart color-2"><a href="Corporate_blog/Corporate-2.php">Corporate</a></span>
                                            <span class="post-box-cart1"><a href="Corporate_blog/Corporate-2.php"><i class="far fa-calendar-alt"></i> 30 May 2024</a></span>
                                        </div>
                                        <h4><a href="Corporate_blog/Corporate-2.php">What Is Corporate Culture? 4 Types of Corporate Culture</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
