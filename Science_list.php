...
<head>
    ...
    <title>Science List</title>
    <meta name="description" content="Earth’s Climate May Be Shaped By The Sun’s Galactic Journey">
...
<body>
    ...
    <main>
        ...
        <div class="breadcrumb-area pt-30 hero-padding">
            <div class="container">
                <div class="breadcrumb-bg pt-115 pb-115" style="background-image:url(Science_blog/img/science-banner-2.webp)">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="row mb-30">
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
                                <div class="postbox">
                                    <div class="post-img">
                                        <a href="Science_blog/Science-blog-1.php"><img src="Science_blog/img/science-blog-1.jpg" alt=""></a>
                                    </div>
                                    <div class="post-box-text mt-30">
                                        <div class="post-box-meta">
                                            <span class="post-box-cart color-1"><a href="Science_blog/Science-blog-1.php">Science</a></span>
                                            <span class="post-box-cart1"><a href="Science_blog/Science-blog-1.php"><i class="far fa-calendar-alt"></i> 30 May 2024</a></span>
                                        </div>
                                        <h4><a href="Science_blog/Science-blog-1.php">Earth’s Climate May Be Shaped By The Sun’s Galactic Journey</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-25">
